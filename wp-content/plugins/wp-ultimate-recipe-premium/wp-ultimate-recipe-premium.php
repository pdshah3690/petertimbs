...
License: GPLv2
*/
define( 'WPURP_PREMIUM_VERSION', '3.12.9' );
...
if ( class_exists( 'WPUltimateRecipe' ) ) {
    wp_die( __( "You need to deactivate the free WP Ultimate Recipe plugin before activating the Premium version. WP Ultimate Recipe Premium is a stand-alone plugin since version 2. You won't lose any settings or recipes when deactivating.", 'wp-ultimate-recipe' ), 'WP Ultimate Recipe Premium', array(
        'back_link' => true,
    ) );
} else {
