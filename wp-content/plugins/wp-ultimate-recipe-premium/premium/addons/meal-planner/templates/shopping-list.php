...
<div class="wpurp-meal-plan-footer-actions">
    ...
    <div class="wpurp-meal-plan-footer-actions-right">
        ...
        <?php } ?>
        <?php if ( WPUltimateRecipe::option( 'meal_planner_print_shopping_list_button', '1' ) == '1' ) : ?>
        <button type="button" class="wpurp-meal-plan-button wpurp-meal-plan-shopping-list-print" onclick="RecipeMealPlanner.printShoppingList(this)"><?php _e( 'Print', 'wp-ultimate-recipe' ); ?></button>
        <?php endif; ?>
    </div>
</div>