...
class WPURP_Nutritional_Information extends WPURP_Premium_Addon {
    ...
    public function __construct( $name = 'nutritional-information' )
    {
        ...
        add_action( 'amp_post_template_css', array( $this, 'amp_style' ) );
	...
	public function amp_style() {
		// Get AMP specific CSS.
		ob_start();
        include( $this->addonDir . '/css/nutrition-label.css' );
		$css = ob_get_contents();
		ob_end_clean();
    ...
    public function label( $recipe, $label_serving_size = 0 )
    {
        ...
        return apply_filters( 'wpurp_output_recipe_nutrition_label', $output );
    }
