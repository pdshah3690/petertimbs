...
function wpurp_register_widget_nutrition_label() {
    register_widget( 'WPURP_Nutrition_Label_Widget' );
}
add_action( 'widgets_init', 'wpurp_register_widget_nutrition_label' );