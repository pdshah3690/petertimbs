...
class WPURP_User_Menus extends WPURP_Premium_Addon {
    ...
    {
        add_submenu_page( 'edit.php?post_type=recipe', 'WP Ultimate Recipe ' . __( 'Ingredient Groups', 'wp-ultimate-recipe' ), __( 'Ingredient Groups', 'wp-ultimate-recipe' ), WPUltimateRecipe::option( 'ingredient_groups_capability', 'manage_options' ), 'wpurp_ingredient_groups', array( $this, 'ingredient_groups_menu_page' ) );
    }
