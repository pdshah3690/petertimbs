  ...
  public function nectar_get_post_grid_segment() {
    ...
    if( 'portfolio' === $post_type ) {
      ...
      if( !empty($custom_query_tax) ) {
        ...
        /**
         * Build term objects from the provided term IDs directly.
         *
         * Using `get_terms()` across all taxonomies can result in empty results in some setups
         * (e.g. language plugins filtering terms), which would remove tax_query and return ALL posts.
         */
