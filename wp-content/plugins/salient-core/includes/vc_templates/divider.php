...
extract(shortcode_atts(array(
  ...
  'delay' => ''), $atts));
	...
	} else if( strpos($custom_height,'svh') !== false ) {
		$calculated_height      = intval($custom_height) . 'svh';
		$calculated_height_half = intval($custom_height)/2 . 'svh';
	} else if( strpos($custom_height,'lvh') !== false ) {
		$calculated_height      = intval($custom_height) . 'lvh';
		$calculated_height_half = intval($custom_height)/2 . 'lvh';
