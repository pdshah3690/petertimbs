...
$nectar_cta_params = array(
	...
	array(
		'type' => 'nectar_range_slider',
		'heading' => esc_html__('Min Icon Size', 'salient-core'),
		'param_name' => 'min_icon_size',
		"dependency" => array('element' => "btn_style", 'value' => array('arrow-circle-animation')),
		'description' => esc_html__('Controls the minimum size of the icon.', 'salient-core'),
		'value' => '36',
		'options' => array(
			'min' => '20',
			'max' => '50',
