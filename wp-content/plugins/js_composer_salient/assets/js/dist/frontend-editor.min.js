    ...
    e = r.extend(d.view.AttachmentCompat.prototype.render), d.view.AttachmentCompat.prototype.render = function() {
        ...
        o(".media-modal").addClass("processing-media"), t(i, function(e) {
            ...
            switch (i.reset(e), t = r.map(i.models, function(e) {
                ...
                case "single":
                     /* nectar addition */
                     // verify that  t, e = r.map(e, function(e) { exists above. is. "t" since it could change in the future
                     var objects = t;
                     //hotspot logic
    ...
    window.vc.AddElementUIPanelFrontendEditor = vc.AddElementUIPanelBackendEditor.vcExtendUI(vc.HelperPanelViewHeaderFooter).extend({
        ...
        createElement: function(e) {
            ...
            i = vc.getMapped(t), _.isString(i.default_content) && i.default_content.length && (e = this.builder.parse({}, i.default_content, this.builder.last().toJSON()), _.each(e, function(e) {
                e.default_content = !0, this.builder.create(e)
            }, this)), this.model || (this.model = this.builder.last()), window.vc.latestAddedElement = this.model, l = !(_.isBoolean(i.show_settings_on_create) && !1 === i.show_settings_on_create);
            this.hide(), l && this.showEditForm(), this.builder.render(null, this.model)
        },
...
_.isUndefined(window.vc) && (window.vc = {}), _.extend(vc, {
    ...
    vc.map = {}, vc.setFrameSize = function(e) {
        ...
        changed: function() {
            //nectar addition - changed jquery height for performance
            var omittiedElements = [
                'vc_nectar_badge',
                'vc_fancy_box',
                'vc_nectar_single_testimonial',
                'vc_vc_row_inner'
            ];

            for (var cls of omittiedElements) {
