...
<div id="<?php echo esc_attr( $full_width_portfolio ); ?>" <?php echo $password_protected_attr; ?><?php if ( ! empty( $bg ) && $fwp !== 'enabled' || ! empty( $bg_color ) && $fwp !== 'enabled' ) { echo ' data-project-header-bg="true"'; } ?> data-featured-img="<?php if ( isset($featured_src[0]) ) { echo esc_attr( $featured_src[0] ); } ?>">
