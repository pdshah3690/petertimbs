...
if( !empty($nectar_options['header-color']) && $nectar_options['header-color'] === 'custom' ) {
    ...
    body[data-header-format="left-header"].material #search-outer,
	 ...
	 if( isset($nectar_options['header-bg-opacity']) && !empty($nectar_options['header-bg-opacity']) ) {
			 ...
			 if ( nectar_is_contained_header() ) {
				...
				if ( $nectar_options['header-bg-opacity'] != '100'  ) {
					echo '.material #header-outer:not(.material-search-open) #search-outer:before,
					.material #header-outer:not(.material-search-open) .bg-color-stripe,
					#header-outer:not(.material-search-open) #search-outer #search-box,
					#header-outer:not(.material-search-open) #search-outer #search #close {
