    ...
    // Icon Element.
      ...
      // Nectar CTA Element.
          ...
          if ( $button_style === 'arrow-circle-animation' ) {
           ...
           .nectar-cta[data-style="arrow-circle-animation"][data-using-bg="true"] .text {
            ...
            .nectar-cta[data-style="arrow-circle-animation"] .arrow-circle-animation-arrow-wrap {
              ...
              border-radius: 100%;
              overflow: hidden;
              width: max(var(--nectar-button-size, 1.4em), var(--nectar-min-icon-size, 35px) );
              transition:
          ...
          .span_12.light .nectar-cta[data-style="arrow-circle-animation"]:not([data-using-bg="true"]) .arrow-circle-animation-arrow-wrap  {
            ...
            .nectar-cta[data-style="arrow-circle-animation"] .link_wrap:hover .arrow-circle-animation-arrow {
              transform: translate(50%, -150%);
              fill: var(--nectar-button-color-hover, var(--nectar-button-color, currentColor));
            }
            .nectar-cta[data-style="arrow-circle-animation"] .link_wrap:hover .arrow-circle-animation-arrow-wrap {
              background-color: var(--nectar-text-color-hover, var(--nectar-text-color, #fff));
      ...
      // Post Grid Element
        ...
        if( isset($atts['grid_item_height']) && !empty($atts['grid_item_height']) ) {
          ...
          self::$element_css[] = '
            .nectar-post-grid[data-grid-item-height="'.esc_attr($atts['grid_item_height']).'"] .nectar-post-grid-item {
              ...
              '.(false !== strpos($atts['grid_item_height'], 'vh') ? 'min-height: '.preg_replace('/[^0-9.]/', '', esc_attr($atts['grid_item_height'])).'svh;' : '').'
            }';
          ...
          if( $post_grid_style === 'content_under_image' ) {
            ...
            .nectar-post-grid-wrap[data-style="content_under_image"] [data-grid-item-height="'.esc_attr($atts['grid_item_height']).'"] .nectar-post-grid-item-bg {
              ...
              '.(false !== strpos($atts['grid_item_height'], 'vh') ? 'height: '.preg_replace('/[^0-9.]/', '', esc_attr($atts['grid_item_height'])).'svh;' : '').'
            }';
       ...
       if ( isset($atts['display_type']) && 'carousel' === $atts['display_type'] ) {
        ...
        div[class*="flex_layout"] .nectar-post-grid-wrap,
        div[class*="column_element_direction"] .nectar-post-grid-wrap {
          min-width: 0;
          width: 100%;
        }

        div[class*="flex_layout"] .nectar-flickity.nectar-post-grid,
        div[class*="column_element_direction"] .nectar-flickity.nectar-post-grid {
          min-width: 0;
        }
        ...
        // 3 columns ==============================
            ...
            if( 'vert_staggered' === $masonry_variant ) {
              ...
              if( $post_grid_style === 'content_under_image' || $post_grid_style === 'content_overlaid' ) {
                  ...
                  @media only screen and (max-width: 999px) and (min-width: 691px) {
                    ...
                    #ajax-content-wrap .nectar-post-grid-wrap[data-style="content_under_image"] .nectar-post-grid[data-columns="3"].layout-vert_staggered > div:nth-child(6n + 1) .content {
                      position: static;
                      padding-top: 15vw;
                      padding-bottom: 15vw;
                    }
                  ...
                  .nectar-post-grid-wrap[data-style="content_under_image"] [data-text-align="center"][data-columns="3"].layout-vert_staggered > div:nth-child(6n + 1) .content {
                      align-items: center;
                      height: 100%;
                      width: 100%;
                      max-width: 100%;
                  ...
                  .nectar-post-grid-wrap[data-style="content_under_image"] [data-text-align="center"][data-columns="3"].layout-vert_staggered > div:nth-child(6n + 1) .content .item-main {
                    max-width: 80%;
                  }
          ...
          if( isset($atts['columns']) && '4' === $atts['columns'] ) {
            ...
            if( 'mixed' === $masonry_variant ) {
              ...
              .nectar-post-grid-wrap[data-style="content_under_image"] [data-text-align="center"][data-columns="4"].layout-mixed > div:nth-child(10n + 1) .content {
                    align-items: center;
                    height: 100%;
                    width: 100%;
                    max-width: 100%;
            ...
            if( 'vert_staggered' === $masonry_variant ) {
              ...
              @media only screen and (min-width: 1px) {
                ...
                .nectar-post-grid-wrap[data-style="content_under_image"] [data-text-align="center"][data-columns="4"].layout-vert_staggered > div:nth-child(6n + 1) .content  {
                  align-items: center;
                  height: 100%;
                  width: 100%;
                  max-width: 100%;
              ...
              @media only screen and (max-width: 999px) {
                ...
                #ajax-content-wrap .nectar-post-grid-wrap[data-style="content_under_image"] .nectar-post-grid[data-columns="4"].layout-vert_staggered > div:nth-child(6n + 1) .content {
                  padding-top: 15vw;
                  padding-bottom: 15vw;
                }
            ...
            if( 'vert_staggered_middle' === $masonry_variant ) {
              ...
              @media only screen and (min-width: 1000px) {
                ...
                .nectar-post-grid-wrap[data-style="content_under_image"] [data-columns="4"].layout-vert_staggered_middle:not([data-text-align="center"]) > div:nth-child(7n + 2) .content {
                  max-width: 80%;
                }
              ...
              @media only screen and (max-width: 999px) {
                ...
                #ajax-content-wrap .nectar-post-grid[data-columns="4"].layout-vert_staggered_middle[data-text-align="center"] > div:nth-child(7n + 2) .content {
                  padding-top: 10vw;
                  padding-bottom: 10vw;
                }
                [data-text-layout*="all_bottom_left"][data-columns="4"].layout-vert_staggered_middle > div:nth-child(7n + 2) .content {
  ...
  */
  public static function percent_unit_type($str, $forced_unit = false) {
    ...
    if( false !== strpos($str,'%') ) {
      ...
      $vh_unit = apply_filters('nectar_prefer_svh', false) ? 'svh' : 'vh';
      return intval($str) . $vh_unit;
    }
    ...
    foreach( self::$devices as $device => $media_query_size) {
      ...
      if( !empty($transform_vals) ) {
        ...
        if( false === $transform_y && false !== $transform_x ) {
          ...
          $css[] = '@media only screen '.$media_query_size.'  {
            '.$html_selector.$body_selector.'.'.$element_name.'.translate_x_'.$device.'_'. esc_attr( self::percent_unit_type_class($atts['translate_x_'.$device]) ) . $transform_selector .' {
        ...
        // Y only.
          ...
          $css[] = '@media only screen '.$media_query_size.'  {
            '.$html_selector.$body_selector.'.'.$element_name.'.translate_y_'.$device.'_'. esc_attr( self::percent_unit_type_class($atts['translate_y_'.$device]) ) . $transform_selector .' {
            -webkit-transform: '.esc_attr( $transform_vals ).';
            transform: '.esc_attr( $transform_vals ).';
          } }';
        ...
        // X and Y.
          ...
          $css[] = '@media only screen '.$media_query_size.'  {
            '.$html_selector.$body_selector.'.'.$element_name.'.translate_x_'.$device.'_'. esc_attr( self::percent_unit_type_class($atts['translate_x_'.$device]) ) .'.translate_y_'.$device.'_'. esc_attr( self::percent_unit_type_class($atts['translate_y_'.$device]) ) . $transform_selector .' {
            -webkit-transform: '.esc_attr( $transform_vals ).';
            transform: '.esc_attr( $transform_vals ).';
          } }';
