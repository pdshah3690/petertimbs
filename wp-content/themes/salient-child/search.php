				...
				<div id="search-results" data-layout="<?php echo esc_attr( $search_results_layout ); ?>">
					...
					if ( have_posts() ) :
						while ( have_posts() ) :
							...
							if ( get_post_type( $post->ID ) === 'post' ) { ?>
								<article class="result" data-post-thumb="<?php echo esc_attr( $using_post_thumb ); ?>">
									<div class="inner-wrap">
										...
										?>
										<h2 class="title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a> <span><?php echo esc_html__( 'News', 'salient' ); ?></span></h2>
										<?php
							...
							<?php } elseif ( get_post_type( $post->ID ) === 'recipe' ) { ?>
								<article class="result" data-post-thumb="<?php echo esc_attr( $using_post_thumb ); ?>">
									<div class="inner-wrap">
										<?php
										if ( has_post_thumbnail( $post->ID ) ) {
										...
										?>
										<h2 class="title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a> <span><?php echo esc_html__( 'Recipe', 'salient' ); ?></span></h2>	
										<?php
										if ( $search_results_layout === 'list-no-sidebar' ) {
											the_excerpt(); }
										?>
