        ...
        if(wp_doing_ajax()) {
            ...
            if(!$is_local) {
                ...
                if(!empty($days)) {
                    ...
                    } else if(in_array($_POST['postcode'],$zone_two)) {
                        $zone_price = $option['zone_two']['min_cart_amount'];
                    } else if(in_array($_POST['postcode'],$zone_three)) {
                        $zone_price = $option['zone_three']['min_cart_amount'];
                    } else if(in_array($_POST['postcode'],$zone_four)) {
                        $zone_price = $option['zone_four']['min_cart_amount'];
                    } else if(in_array($_POST['postcode'],$north_island_postcodes)) {
                        $zone_price = $option['north_island_postcodes']['min_cart_amount'];
                    } else if(in_array($_POST['postcode'],$south_island_postcodes)) {
